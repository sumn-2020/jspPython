...
<div class="row">
	...
	<div class="col">
		...
		<ul id="destUL" data-target="/destImgs" class="list-group" > <!-- data속성의 key :  target-->
		</ul>
	</div>
</div>
...
*/
	...
	// => $("#copyBtn").on("click", function(){
 	$(document).on("click", "#copyBtn",  function(event){
		...
		$.post("<%=request.getContextPath() %>/browsing/fileManager", data1, function(resp) { 
			//resp안에 result값 넘어왔음 
			if(resp.result){//넘어와서 데이터가 있으면 
