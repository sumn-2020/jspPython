...
https://m.blog.naver.com/PostView.naver?isHttpsRedirect=true&blogId=javaking75&logNo=140187852894
...
<body>
	...
	<%
		...
		int yy = cal.get(Calendar.YEAR); //현재 년
		int mm = cal.get(Calendar.MONTH) + 1; //현재 달 1~12월
	...
	<div class="container">
		...
		<div class="top-box">
			...
			<a href="?year=<%= yy %>&month=<%= mm %>"><%=formatter2.format(date)%></a>
		</div>
